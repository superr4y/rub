 # From: http://pydes.cvs.sourceforge.net/viewvc/pydes/pyDes/pyDes.py?revision=1.9
 # I add some debug output to prevent a monkey task excercise :P
...
def print_bin(data):
    print map(lambda c: bin(ord(c)), data)
